...
```{bash, eval=FALSE}
conda create -n milo_env -c conda-forge -c bioconda r-rmarkdown bioconductor-milor bioconductor-scater -y
```
...
dir_path <- 'milo_data'
url <- 'https://www.dropbox.com/scl/fi/mhmrk9jimn0n1sasd0cqf/milo_data.rds?rlkey=taoyq18gizpxjodri6lj0bn14&st=na0zqg5r&raw=1'
